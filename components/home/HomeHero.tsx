...
export function HomeHero() {
  ...
  return (
    <section className="relative overflow-hidden bg-blob-gradient pb-20 pt-16 sm:pb-28 sm:pt-20">
      ...
      <div className="container-page relative grid items-center gap-14 lg:grid-cols-2">
        <div className="flex flex-col items-start gap-6">
          ...
          <FadeIn delay={0.08}>
            <h1 className="text-balance font-heading text-4xl font-bold leading-tight text-brand-deep-dark sm:text-5xl">
              {hero.title}
            </h1>
          </FadeIn>
          <FadeIn delay={0.16}>
            <p className="text-balance text-lg font-medium text-brand-blue">{hero.subtitle}</p>
          </FadeIn>
          <FadeIn delay={0.22}>
        ...
        <FadeIn delay={0.2} direction="left" className="relative">
          <div className="relative mx-auto max-w-md lg:max-w-none">
            <div className="relative aspect-[1164/1351] w-full overflow-hidden rounded-3xl shadow-xl shadow-brand-deep/10">
              <Image
                src="/images/hero.png"
