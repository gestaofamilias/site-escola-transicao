...
export const projetosContent = {
  ...
  projects: [
    { icon: BookOpen, title: "Projeto de leitura", description: "Histórias que despertam a imaginação e ampliam a linguagem.", image: "[INSERIR_FOTO_PROJETO_1]" },
    { icon: Music, title: "Musicalização", description: "Ritmo, sons e expressão através da música.", image: "[INSERIR_FOTO_PROJETO_2]" },
    { icon: Palette, title: "Arte e criatividade", description: "Expressão livre por meio de cores, formas e materiais.", image: "[INSERIR_FOTO_PROJETO_3]" },
    { icon: Activity, title: "Atividades motoras", description: "Movimento, equilíbrio e coordenação em brincadeiras dirigidas.", image: "[INSERIR_FOTO_PROJETO_4]" },
    { icon: Wind, title: "Experiências sensoriais", description: "Texturas, cheiros e sons que estimulam os sentidos." },
    { icon: HeartHandshake, title: "Educação socioemocional", description: "Espaço para nomear emoções e fortalecer vínculos." },
